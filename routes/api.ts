...
router.post("/email", async (req, res) => {
  ...
  let transporter = nodemailer.createTransport({
    // @ts-ignore
    host: process.env.SENDINBLUE_SMIP_HOST,
    port: process.env.SENDINBLUE_SMIP_PORT,
    secure: false, // true for 465, false for other ports
    auth: {
      user: process.env.SENDINBLUE_SMIP_USER, // generated ethereal user
      pass: process.env.SENDINBLUE_SMIP_PASSWORD, // generated ethereal password
    },
  });
